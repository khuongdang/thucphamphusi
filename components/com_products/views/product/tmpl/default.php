...
<?php
defined('_JEXEC') or die;
$id_product = $this->params->get('show_page_heading');
$product_info = Util::getProductInfo($id_product);
?>
        ...
        <div class="single-top-main">
            ...
            <div class="col-md-7 single-top-left ">
                <div class="single-right">
                    ...
                    <div class="add add-3">
                        <button class="btn btn-danger my-cart-btn my-cart-b" data-id="1" data-name="Wheat"
                                data-summary="summary 1" data-price="6.00" data-quantity="1" data-image="images/si.jpg">
                            Add to Cart
                        </button>
                    </div>
                    <div class="clearfix"></div>
