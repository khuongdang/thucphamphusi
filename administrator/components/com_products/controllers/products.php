 ...
 * @since  1.6
 */
class ProductsControllerProducts extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		try
		{
			if (empty($pks))
			{
				throw new Exception(JText::_('COM_PRODUCTS_NO_ELEMENT_SELECTED'));
			}

			ArrayHelper::toInteger($pks);
			$model = $this->getModel();
			$model->duplicate($pks);
			$this->setMessage(Jtext::_('COM_PRODUCTS_ITEMS_SUCCESS_DUPLICATED'));
		}
		catch (Exception $e)
		{
