            ...
            <legend><?php echo JText::_('COM_SEF_ANALYTICS'); ?></legend>
          	<table class="adminform table table-striped">
                ...
                */
                ?>
          		<tr<?php $x++; echo (($x % 2) ? '':' class="row1"' );?>>
          			<td width="20"><?php echo $this->tooltip(JText::_('COM_SEF_TT_GOOGLE_WEB_ID'),JText::_('COM_SEF_WEB_ID')); ?></td>
          			<td width="200"><?php echo Jtext::_('COM_SEF_WEB_ID'); ?></td>
