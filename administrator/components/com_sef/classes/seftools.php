...
class SEFTools
{
    ...
    static function GetSEFGlobalMeta() {
        return 'acb66eab7b3fd5bfc18f99ffaa11e1e5'; // sef.global.meta
    }
    ...
    /**
     * Creates a new instance of JoomSefDomainUri object copied from given JUri with given host set. The JoomSefDomainUri
     * is used with multi-language websites using different domains, its toString method always outputs scheme and host.
     *
     * @param JUri $srcUri
     * @param string $host
     * @return JoomSefDomainUri
     */
    public static function createDomainUri($srcUri, $host)
    {
        $srcUri->setHost($host);
        $newUri = new JoomSefDomainUri();
        JoomSefUri::copyUri($srcUri, $newUri);
        $newUri->storeHost();
        return $newUri;
    }
}
